        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h1>Over 40+ unique view
                    <br/>
                    <span class="navy"> with many custom components</span>
                </h1>
        ...
        <div class="row features-block">
            <div class="col-lg-6 features-text wow fadeInLeft">
                ...
                <p>INSPINIA Admin Theme is a premium admin dashboard template with flat design concept. It is fully responsive
                    admin dashboard template built with Bootstrap 3+ Framework, HTML5 and CSS3, Media query. It has a huge
                    collection of reusable UI components and integrated with latest jQuery plugins.</p>
        ...
        <div class="container">
            ...
            <div class="row features-block">
                <div class="col-lg-3 features-text wow fadeInLeft">
                    ...
                    <h2>Perfectly designed </h2>
                    <p>INSPINIA Admin Theme is a premium admin dashboard template with flat design concept. It is fully responsive
                        admin dashboard template built with Bootstrap 3+ Framework, HTML5 and CSS3, Media query. It has a
                        huge collection of reusable UI components and integrated with latest jQuery plugins.</p>
                    <a href="" class="btn btn-primary">Learn more</a>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 col-lg-offset-1 features-text">
                    ...
                    <p>INSPINIA Admin Theme is a premium admin dashboard template with flat design concept. It is fully responsive
                        admin dashboard template built with Bootstrap 3+ Framework, HTML5 and CSS3, Media query. It has a
                        huge collection of reusable UI components and integrated with.</p>
                </div>
            ...
            <div class="row m-t-lg">
                <div class="col-lg-8 col-lg-offset-2 text-center m-t-lg">
                    <p>*Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text,
                        ...
                        <span class="navy">Various versions</span> have evolved over the years, sometimes by accident, sometimes on purpose
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center m-t-lg m-b-lg">
                    <p>
                        ...
                        <br/> consectetur adipisicing elit. Aut eaque, laboriosam veritatis, quos non quis ad perspiciatis, totam
